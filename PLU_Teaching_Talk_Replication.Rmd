---
title: "PLU Active Teaching Demonstration Replication"
...
load("/Users/carlosalgara/Desktop/carlos_school/PhD_UC Davis/Academic Job Market/Campus Visit Materials/PLU_Teaching_Demonstration/PLU_Demonstration_Replication.Rdata")

```
To replicate the following tutorial, you can find the following replication materials here: 

* ***[R Code Script](PLU_Replication_Analysis_Posted.R)*** 

* ***[Tutorial Data in R Environment form](PLU_Demonstration_Replication.Rdata)***

* You can also find the original slide-set of the presentation here: ***[Variation in Citizen Participation: Resources & Free-Riding Incentive](PLU_Teaching_Demonstration_Talk_Algara.pdf)***.   
...
This relationship continues with respect to the probability of being a campaign donor. As one can see, there is a strong relationship between education and the probability of being a campaign donor. For example, you are 34% more likely to contribute to a campaign if you hold a post-graduate degree and only 10% if you hold just a high school diploma. Note that the probability of contributing to a campaign is far lower, across all discrete education groups, than it is for voting. This reflects variation in the cost of differing forms of political participation, with contributing to campaigns being a far more costly form of political expression. We see the same relationship below with respect to citizen income and the probability of turning out to vote.
...
As one can see, non-universal turnout is not a significant problem with respect to potentially securing ``correct'' representation. In this example, 400 citizens turned out to vote (a 44% turnout-rate, which is about on-par with your average off-year midterm election cycle). However, this is not a problem since this sample of voters is perfectly representative of the district population, with roughly 200 Lutes and 200 Loggers paying the cost to turn out to vote. Where could this be a problem? The visualization below can provide a clue.
