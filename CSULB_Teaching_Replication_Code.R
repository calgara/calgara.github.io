...
setwd("/Users/carlosalgara/Desktop/carlos_school/PhD_UC Davis/Academic Job Market/2019_2020_JM_Updated_Materials/Campus Visit Materials/California State University, Long Beach/Teaching Talk")
...
plot <- ggplot(data= predict, mapping=aes(x=educ, y=fit,ymin=lower,ymax=upper,label=round(predict$fit,1))) + geom_errorbar(width=0.2,size=1) + geom_point(size=4, shape=21, fill="white") + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_x_discrete("Voter Education Level",labels=c("> HS", "HS","Some \nCollege","2-Yr \nCollege","BA","Post-Grad")) + scale_y_continuous("Estimated Political Knowledge",breaks=seq(0,6,0.5)) + labs(title="Effect of Education on Citizen Political Knowledge",subtitle="Data: 2016 American National Election Study") + geom_text(size=3.5,hjust =0,nudge_x = 0.175)
ggsave(plot,file="education2.png", width = 8, height = 5.22, units = "in")
...
ggsave(plot,file="contribution_education_2016_2018.png", width = 8, height = 5.22, units = "in")
...
ggsave(plot,file="contribution_income_level_2016_2018.png", width = 8, height = 5.22, units = "in")
...
plot <- ggplot(df, aes(x = x, y = y, fill = category)) + geom_tile(color = "black", size = 0.5) + scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0), trans = 'reverse') + scale_fill_manual("",values = c("gold","blue2")) + labs(title="Fictional Even District of 49ers & Titans", caption="Each Square Represents a Single Voter \n(N = 200 The Beach & 200 Fullerton)") + theme(plot.title = element_text(size = rel(1.2)),axis.text = element_blank(), axis.title = element_blank(), axis.ticks = element_blank(),legend.title = element_blank(), legend.position = "bottom",legend.box.just = "left", legend.key.size = unit(1,"line"), legend.key = element_rect(size = 0, color = 'white'), legend.text.align = 0, legend.box = "horizontal",legend.spacing.x = unit(0.25, 'cm'))
ggsave(file="fictional_district.png", plot, width = 8, height = 5, units = "in") 
...
plot <- ggplot(df, aes(x = x, y = y, fill = bias2)) + geom_tile(color = "black", size = 0.5) + scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0), trans = 'reverse') + scale_fill_manual("",values = c("gold","blue2")) + labs(title="Bias Turnout in Fictional Even District of 49ers & Titans", caption="Each Square Represents a Single Voter \n(N = 300 (75%) The Beach & 100 (25%) Titans voters)") + theme(plot.title = element_text(size = rel(1.2)),axis.text = element_blank(), axis.title = element_blank(), axis.ticks = element_blank(),legend.title = element_blank(), legend.position = "bottom",legend.box.just = "left", legend.key.size = unit(1,"line"), legend.key = element_rect(size = 0, color = 'white'), legend.text.align = 0, legend.box = "horizontal",legend.spacing.x = unit(0.25, 'cm'))
ggsave(file="bias_turnout2.png", plot, width = 8, height = 5, units = "in") 
